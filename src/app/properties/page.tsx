...
import { listings, sortOptions } from "@/data/property";
...
export default function Properties() {
	...
	const filtered = listings.filter((l) => {
		if (activeCategory !== "All" && l.tag !== activeCategory) return false;
		if (activeType !== "All Types" && l.type !== activeType) return false;
		if (!priceMatchesRange(l.price, activePriceRange)) return false;
	...
	return (
		...
		>
			...
			>
				...
				<div className="relative max-w-7xl mx-auto px-4 md:px-6 pt-10 pb-10">
					...
					<p className="text-white/50 text-sm mb-7">
						Browse {listings.length} premium properties across
						London and the UK
					</p>
			...
			<div className="flex-1 max-w-7xl mx-auto w-full px-4 md:px-6 py-6">
				{/* Toolbar row — just sort + view mode + result count */}
